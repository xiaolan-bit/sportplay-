...
export default {
  ...
  props: {
    ...
    stepArray: {
      ...
      default: function () {
        this.$forceUpdate();
        console.log("this is forceUpdate chartsList");
  ...
  methods: {
    ...
    async showtuijianroute(orderid, placeA, placeB) {
      ...
      this.chartsList = res.placeAs;
      this.$forceUpdate();
      console.log("this is chartsList");
      console.log(this.chartsList);
      console.log(orderid);
      console.log(res);
    },
