        ...
        series: [
          {
            ...
            name: "浏览器访问量占比",
            data: [
              ["中远集团", JSON.parse(sessionStorage.getItem("zhongyuan"))],
              ["顺丰速递", JSON.parse(sessionStorage.getItem("sunfeng"))],
              ["京东快递", JSON.parse(sessionStorage.getItem("jingdong"))],
              ["中国外运", JSON.parse(sessionStorage.getItem("zhongguo"))],
              ["其他", 0.7],
            ],
          },
        ],
