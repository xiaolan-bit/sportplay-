      ...
      <el-row>
        <!-- 名称 --><el-col :span="6">
          <el-form-item label="货物名称" prop="goodsname" label-width="100px">
            <el-input v-model="addForm.goodsname" ></el-input> </el-form-item
        ></el-col>
        <!-- 尺寸 --><el-col :span="6">
        ...
        <el-row v-show="addForm.transtype == '箱装'">
          <!-- 箱号 -->
            <el-form-item label="箱号" prop="boxid" label-width="100px">
              <el-input v-model="addForm.boxid" style="width:223px"></el-input> </el-form-item
          >
          ...
          <el-row v-show="checkboxid() && boolboxid == '0'">
            ...
            <!-- 持箱人 -->
              <el-form-item label="持箱人" prop="boxowner" label-width="100px">
                <el-input v-model="addForm.boxowner" style="width:223px"></el-input> </el-form-item
            >
            <!-- 箱皮重 -->
          ...
          <!-- 铅封号 --><el-col :span="6">
            <el-form-item label="铅封号" prop="leadseal" label-width="100px">
              <el-input v-model="addForm.leadseal"></el-input> </el-form-item
          ></el-col>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    addOrder() {
      ...
      this.$refs.addFormRef.validate(async (valid) => {
        if (!valid) return;
        const { data: res } = await this.$http.post("addhuodaiOrder", this.addForm);
